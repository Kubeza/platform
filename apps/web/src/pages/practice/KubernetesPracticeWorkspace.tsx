...
const INITIAL_COMMANDS: TerminalCommand[] = [
  {
    id: "kubernetes-welcome",
    command: "",
    output: [
      "Welcome to your Kubernetes practice environment.",
      "",
      "A Kubernetes cluster is ready for practice.",
      "Explore pods, deployments, services, namespaces, and workloads.",
      "",
...
const INITIAL_MENTOR_MESSAGES: AIChatMessage[] = [
  {
    id: "kubernetes-mentor-1",
    role: "assistant",
    content:
      "Your Kubernetes cluster is ready. Explore pods, deployments, services, namespaces, and workloads. Ask me anything about what you're practicing.",
    timestamp: "AI Mentor",
  },
];

export default function KubernetesPracticeWorkspace(): React.JSX.Element {
    ...
    window.setTimeout(() => {
      setMentorMessages((current) => [
        ...current,
        {
          ...
          role: "assistant",
          content:
            "I'm ready to help with Kubernetes practice. Ask me about pods, deployments, services, namespaces, kubectl commands, workloads, or anything you're working on.",
          timestamp: "AI Mentor",
        },
      ]);
    }, 400);
      ...
      <header className="flex h-14 shrink-0 items-center justify-between border-b border-white/[0.08] bg-[#070B16] px-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            aria-label="Reset Kubernetes environment"
          >
            ...
            <div className="min-h-0 flex-1 overflow-hidden px-4 py-5">
              <div className="rounded-xl border border-white/[0.07] bg-white/[0.015] p-4">
                ...
                <p className="mt-3 text-xs leading-5 text-slate-600">
                  Practice pods, deployments, services, namespaces, and workloads.
                </p>
              </div>
              ...
              <div className="mb-4 flex shrink-0 items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-600">
                    Work with the cluster directly from the terminal.
                  </p>
                </div>
                    ...
                    >
                      ...
                      <TerminalLine>
                        ...
                        <TerminalInput
                          ...
                          autoFocus
                          aria-label="Kubernetes terminal command"
                          className="ml-2"
                        />
