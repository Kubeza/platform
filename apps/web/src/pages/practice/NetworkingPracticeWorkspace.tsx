...
const INITIAL_COMMANDS: TerminalCommand[] = [
  {
    id: "networking-welcome",
    command: "",
    output: [
      "Welcome to your Networking practice environment.",
      "",
      "Explore interfaces, routes, connectivity,",
      "ports, DNS, and network services.",
      "",
...
const INITIAL_MENTOR_MESSAGES: AIChatMessage[] = [
  {
    id: "networking-mentor-1",
    role: "assistant",
    content:
      "Your networking environment is ready. Explore the network from the terminal and ask me whenever you want to understand what a command or result means.",
    timestamp: "AI Mentor",
  },
];

export default function NetworkingPracticeWorkspace(): React.JSX.Element {
    ...
    window.setTimeout(() => {
      setMentorMessages((current) => [
        ...current,
        {
          ...
          role: "assistant",
          content:
            "I'm ready to help with networking practice. Ask me about interfaces, routes, ports, DNS, connectivity, sockets, or any command you are using.",
          timestamp: "AI Mentor",
        },
      ]);
    }, 400);
      ...
      <header className="flex h-14 shrink-0 items-center justify-between border-b border-white/[0.08] bg-[#070B16] px-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex size-9 items-center justify-center rounded-lg border border-white/[0.08] bg-white/[0.02] text-slate-500 hover:text-white"
            aria-label="Reset networking environment"
          >
            ...
            <div className="min-h-0 flex-1 overflow-hidden px-4 py-5">
              <div className="rounded-xl border border-white/[0.07] bg-white/[0.015] p-4">
                ...
                <p className="mt-3 text-xs leading-5 text-slate-600">
                  Practice interfaces, routing, ports, DNS, and connectivity.
                </p>
              </div>
              ...
              <div className="mb-4 flex shrink-0 items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-600">
                    Explore the network directly from the terminal.
                  </p>
                </div>
                    ...
                    >
                      ...
                      <TerminalLine>
                        ...
                        <TerminalInput
                          ...
                          autoFocus
                          aria-label="Networking terminal command"
                          className="ml-2"
                        />
